...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="<?= base_url("assets/undangan_1/css/menikah.css")?>" />
    <link rel="stylesheet" type="text/css" href="<?= base_url("assets/undangan_1/css/jquery.countdown.css")?>" />
    <script
      src="https://kit.fontawesome.com/2828f7885a.js"
      integrity="sha384-WAsFbnLEQcpCk8lM1UTWesAf5rGTCvb2Y+8LvyjAAcxK1c3s5c0L+SYOgxvc6PWG"
      crossorigin="anonymous"></script>
    <script type="text/javascript" src="https://ajax.googleapis.com/ajax/libs/jquery/1.9.1/jquery.min.js"></script>
    <script src="<?= base_url("assets/undangan_1/js/jquery.coundown.js")?>"></script>
    <link rel="icon" type="image/png" href="<?= base_url("assets/undangan_1/image/favicon.png")?>" />
  ...
  <body>
    ...
    <div class="preloader-wrapper">
      <div class="preloader">
        <img src="<?= base_url("assets/undangan_1/image/favicon.png")?>" alt="Flower" />
      </div>
    </div>
    <!-- End Preloader-->
    <!-- Begin Header -->
    ...
    <!-- Begin regular-section-->
     <section class="section-light no-padding-top regular-section has-text-centered has-vertically-aligned-content" id="regular-section">
        ...
        <div data-aos="fade-up" data-aos-easing="linear">
          <img src="<?= base_url("assets/undangan_1/image/bismillah.png")?>" class="bismillah has-text-centered" alt="Bismillahirrahmaanirrahiim">
        </div>
        ...
        <span class="space40px"></span>
        <div data-aos="fade-up" data-aos-easing="linear">
          <img src="<?= base_url("assets/undangan_1/image/divider-leaves.png")?>" class="divider has-text-centered" alt="~~~">
        </div>
        <span class="space40px"></span>
        <span class="space40px"></span>
      </section>
      ...
      <div class="tile is-ancestor">
        ...
        <div class="tile is-parent">              
          ...
          <div class="space40px"></div>
            <div data-aos="fade-up" data-aos-easing="linear">
              <img src="<?= base_url("assets/undangan_1/image/divider-leaves.png")?>" class="divider has-vertically-align" alt="~~~">
            </div> 
            <div class="space40px"></div>
            <div class="space40px"></div>
    ...
    <script src="<?= base_url("assets/undangan_1/js/menikah.js")?>"></script>
