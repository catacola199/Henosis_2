...
<head>
  ...
  <link rel="stylesheet" href="<?= base_url("assets/undangan_4/style.css")?>">
</head>
      ...
      <div class="row couple">
        <div class="col-lg-6">
          <div class="row">
            ...
            <div class="col-4">
              <img src="<?= base_url("assets/undangan_4/img/sandhika.png")?>" alt="Sandhika Galih" class="img-responsive rounded-circle">
            </div>
          </div>
        </div>
        ...
        <div class="col-lg-6">
          <div class="row">
            <div class="col-4">
              <img src="<?= base_url("assets/undangan_4/img/nofa.png")?>" alt="Nofariza" class="img-responsive rounded-circle">
            </div>
            <div class="col-8">
              <h3>Nofariza</h3>
              <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Atque praesentium aut ipsa perferendis,
