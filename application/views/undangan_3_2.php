...
<head>
    ...
    <!-- App -->
    <link rel="stylesheet" href="<?= base_url("assets/undangan_2/css/app_white.css")?>">
    <script src="<?= base_url("assets/undangan_2/js/app.js")?>" defer></script>
...
<body data-email="user@example.com" data-password="12345678" data-url="https://api.ulems.my.id/" style="overflow-y: hidden;">
    ...
    <!-- Main Content -->
    <main class="" data-bs-spy="scroll" data-bs-target="#navbar-menus" data-bs-root-margin="0px 0px -40%" data-bs-smooth-scroll="true" tabindex="0">

        <!-- Home -->
        <section class="container" id="home">

            <div class="text-center pt-4">
                <h1 class="font-esthetic my-4 text_white" style="font-size: 2.5rem;">Undangan Pernikahan</h1>
                ...
                <h1 class="font-esthetic my-4 text_white" style="font-size: 3rem;">Delviro & Sukma</h1>
                
                <p class="mb-0 text_white" style="font-size: 1.5rem;">Minggu, 03 Maret 2024</p>
                ...
                <a class="btn btn-outline-light btn-sm shadow rounded-pill px-3 my-2" target="_blank" href="https://calendar.google.com/calendar/render?action=TEMPLATE&text=The%20Wedding%20of%20Wahyu%20and%20Riski&details=The%20Wedding%20of%20Wahyu%20and%20Riski%20%7C%2015%20Maret%202023%20%7C%20RT%2010%20RW%2002,%20Desa%20Pajerukan,%20Kec.%20Kalibagor,%20Kab.%20Banyumas,%20Jawa%20Tengah%2053191%20%7C%2010.00%20-%2011.00%20WIB&dates=20230315T100000/20230315T110000&location=https://goo.gl/maps/ALZR6FJZU3kxVwN86">
                    <i class="fa-solid fa-calendar-check me-2 text_white"></i>Save The Date
                </a>

                <div class="d-flex justify-content-center align-items-center mt-4 mb-2">
                    <div class="mouse-animation text_white">
                        <div class="scroll-animation text_white"></div>
                    </div>
                </div>

                <p class="m-0 text_white">Scroll Down</p>
            </div>
        </section>

        <!-- Wave Separator -->
        <svg xmlns="https://www.w3.org/2000/svg" viewBox="0 0 1440 320">
            <path fill="#EEE3CB" fill-opacity="1" d="M0,160L48,144C96,128,192,96,288,106.7C384,117,480,171,576,165.3C672,160,768,96,864,96C960,96,1056,160,1152,154.7C1248,149,1344,75,1392,37.3L1440,0L1440,320L1392,320C1344,320,1248,320,1152,320C1056,320,960,320,864,320C768,320,672,320,576,320C480,320,384,320,288,320C192,320,96,320,48,320L0,320Z"></path>
        </svg>
        ...
        <section class="dark-section" id="mempelai">
            ...
            <div class="text-center">
                <h1 class="font-arabic text_dark py-4 px-2" style="font-size: 2rem">بِسْمِ اللّٰهِ الرَّحْمٰنِ الرَّحِيْمِ</h1>
                <h1 class="font-esthetic text_dark py-4 px-2" style="font-size: 2rem">Assalamualaikum Warahmatullahi Wabarakatuh</h1>

                <p class="pb-3 px-3 text_dark">
                ...
                <div class="overflow-x-hidden">
                    ...
                    <div data-aos="fade-right" data-aos-duration="2000">
                        ...
                        <h1 class="font-esthetic text_dark" style="font-size: 3rem;">Delviro</h1>
                        <p class="mt-3 mb-0 text_dark" style="font-size: 1.25rem;">Putra Ke - 3</p>
                        <p class="mb-0 text_dark">Bapak Yosep & Ibu Siti </p>
                    </div>
                    ...
                    <div data-aos="fade-left" data-aos-duration="2000">
                        ...
                        <h1 class="font-esthetic text_dark" style="font-size: 3rem;">Sukma</h1>
                        <p class="mt-3 mb-0 text_dark" style="font-size: 1.25rem;">Putri Ke - 2</p>
                        <p class="mb-0 text_dark">Bapak Aceng & Ibu Ijah </p>
                    </div>
                </div>
            </div>
        </section>
        ...
        <!-- Wave Separator -->
        <svg xmlns="https://www.w3.org/2000/svg" viewBox="0 0 1440 320">
            <path fill="#EEE3CB" fill-opacity="1" d="M0,192L40,181.3C80,171,160,149,240,149.3C320,149,400,171,480,165.3C560,160,640,128,720,128C800,128,880,160,960,186.7C1040,213,1120,235,1200,218.7C1280,203,1360,149,1400,122.7L1440,96L1440,0L1400,0C1360,0,1280,0,1200,0C1120,0,1040,0,960,0C880,0,800,0,720,0C640,0,560,0,480,0C400,0,320,0,240,0C160,0,80,0,40,0L0,0Z"></path>
        </svg>
        ...
        <section class="dark-section" id="tanggal">
            ...
            <div class="container">
                <div class="text-center">
                    ...
                    <h1 class="font-esthetic py-3 text_dark" style="font-size: 2rem;">Waktu Menuju Acara</h1>
                    <div class="border rounded-pill shadow py-2 px-4 mx-2 mb-4">

                        <!-- Ganti waktunya pada data-waktu (sesuai format tersebut) -->
                        <div class="row justify-content-center" data-waktu="2024-03-03 00:00:00" id="tampilan-waktu">
                            <div class="col-3 p-1">
                                <h2 class="d-inline m-0 p-0 text_dark" id="hari">0</h2><small class="ms-1 me-0 my-0 p-0 d-inline text_dark">Hari</small>
                            </div>
                            <div class="col-3 p-1">
                                <h2 class="d-inline m-0 p-0 text_dark" id="jam">0</h2><small class="ms-1 me-0 my-0 p-0 d-inline text_dark">Jam</small>
                            </div>
                            <div class="col-3 p-1">
                                <h2 class="d-inline m-0 p-0 text_dark" id="menit">0</h2><small class="ms-1 me-0 my-0 p-0 d-inline text_dark">Menit</small>
                            </div>
                            <div class="col-3 p-1">
                                <h2 class="d-inline m-0 p-0 text_dark" id="detik">0</h2><small class="ms-1 me-0 my-0 p-0 d-inline text_dark">Detik</small>
                            </div>
                        </div>
                    </div>

                    <p style="font-size: 0.9rem;" class="mt-4 py-2 text_dark">
                    ...
                    <div class="overflow-x-hidden">
                        <div class="py-2" data-aos="fade-left" data-aos-duration="1500">
                            <h1 class="font-esthetic text_dark" style="font-size: 2rem;">Akad</h1>
                            <p class="text_dark">Pukul 13.00 WIB - Selesai</p>
                        </div>

                        <div class="py-2" data-aos="fade-right" data-aos-duration="1500">
                            <h1 class="font-esthetic text_dark" style="font-size: 2rem;">Resepsi</h1>
                            <p class="text_dark">Pukul 16.00 WIB - 18.00 WIB</p>
                        </div>
                    </div>

                    <div class="py-2" data-aos="fade-up" data-aos-duration="1500">
                        <a href="https://maps.app.goo.gl/WoEoenmDx63GHa6Y7" target="_blank" class="btn btn-outline-light btn-sm rounded-pill shadow-sm mb-2 px-3">
                            <i class="fa-solid fa-map-location-dot me-2 text_dark"></i>Lihat Google Maps
                        </a>
                        <p class="mb-0 mt-1 mx-1 pb-4 text_dark" style="font-size: 0.9rem;">
                            Joglo Adyatma jl. Sidorejo, jl. sonopakis kidul, Sonopakis Lor Ngestiharjo, Kasihan, Bantul
                        </p>
                    </div>
                </div>
            </div>
        ...
        <section class="dark-section" id="galeri">
            ...
            <div class="container pb-2 pt-4">
                <div class="card-body border rounded-4 shadow p-3">
                    ...
                    <h1 class="font-esthetic text-center py-3 text_dark" data-aos="fade-down" data-aos-duration="1500" style="font-size: 2rem;">Galeri</h1>
                    ...
                    <div class="overflow-x-hidden">
                        <div class="row justify-content-center">
                            ...
                            <div class="col-5 card-body border rounded-4 shadow p-3 m-3 " data-aos="fade-down" data-aos-duration="1500">
                                ...
                                <p class="card-text" style="font-size: 0.9rem;">a.n Sukma</p>
                            ...
                            <div class="col-5 card-body border rounded-4 shadow p-3 m-3" data-aos="fade-down" data-aos-duration="1500">
                                ...
                                <p class="card-text" style="font-size: 0.9rem;">a.n Delviro</p>
    ...
    <footer>
        <div class="container">
            <div class="text-center">
                ...
                <p style="font-size: 0.9rem;" class="pt-2 pb-1 px-2 text_dark" data-aos="fade-up" data-aos-duration="1500">
                    Merupakan suatu kehormatan dan kebahagiaan bagi kami apabila, Bapak / Ibu / Saudara / i.
                    berkenan hadir untuk memberikan do'a restunya kami ucapkan terimakasih.
                </p>

                <h1 class="font-esthetic text_dark" data-aos="fade-up" data-aos-duration="2000">Wassalamualaikum Warahmatullahi Wabarakatuh</h1>
                <h1 class="font-arabic py-4 px-2 text_dark" data-aos="fade-up" data-aos-duration="2000" style="font-size: 2rem">اَلْحَمْدُ لِلّٰهِ رَبِّ الْعٰلَمِيْنَۙ</h1>
                ...
                <div class="row align-items-center justify-content-between flex-column flex-sm-row">
                    <div class="col-auto">
                        <small class="text_dark">
                            Build with<i class="fa-solid fa-heart mx-1 text_dark"></i>Henosis
                        </small>
                    </div>
                    <div class="col-auto">
                        <small>
                            <i class="fa-brands fa-github me-1"></i><a target="_blank" href="https://henosisstudio.com/">Henosis</a>
    ...
    <div class="loading-page" id="welcome" style="opacity: 1;">
        <div class="d-flex justify-content-center align-items-center" style="height: 100vh !important;">
            ...
            <div class="text-center">
                <h1 class="font-esthetic text_dark mb-4" style="font-size: 1.5rem;">The Wedding Of</h1>
                <h1 class="font-esthetic text_dark my-4" style="font-size: 2.5rem;">Delviro & Sukma</h1>
                ...
                <h2 class="text_dark" style="font-size: 1rem;">Kepada Bapak/Ibu/Saudara/i</h2>
                <h2 class="text_dark" id="coba2"></h2>
    ...
    <!-- Audio Button -->
    <button type="button" id="tombol-musik" style="display: none;" class="btn btn-light btn-sm rounded-circle btn-music" onclick="util.music(this)" data-status="true" data-url="<?= base_url("assets/undangan_2/assets/music/sound2.mp3")?>">
            ...
            <div class="modal-content">
                <div class="modal-body p-0">
                    <div class="d-flex justify-content-center align-items-center" style="height: 100%;">
                        <img src="<?= base_url("assets/undangan_2/assets/images/bg.jpeg")?>" class="w-100" alt="foto" id="show-modal-image">
                    </div>
                </div>
            </div>
        </div>
    ...
        };
        $( document ).ready(function() {
            console.log( $_GET["nama"] );
            $("#coba").val($_GET["nama"]);
            var nama2 = $_GET["nama"].split("+");

            let kalimat = "";

            // Menggunakan forEach untuk mengiterasi setiap elemen array
            nama2.forEach((nama2, index) => {
                // Menambahkan kata ke dalam kalimat
                kalimat += nama2;
                
                // Menambahkan spasi setelah kata, kecuali untuk kata terakhir
                if (index !== nama2.length - 1) {
                    kalimat += " ";
                }
            });
            $("#coba2").text(kalimat);
