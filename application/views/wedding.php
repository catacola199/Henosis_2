                ...
                <div class="col-md-12">
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="product-item mt-4">
                                <div class="product-img rounded position-relative">
                                    <img class="img-fluid" src="<?= base_url("assets/images/products/pro-5.jpg")?>" alt="" />
                                    <div
                                        class="hover-content text-center w-100 position-absolute bottom-0 start-50 translate-middle-x py-2 mb-3">
                                        <a href="cart.html"><i
                                                class="mdi mdi-cart-outline fs-22 me-3 pe-3 fw-bolder pro-icon text-dark border-end"></i></a>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="product-item mt-4">
                                <div class="product-img rounded position-relative">
                                    <img class="img-fluid" src="<?= base_url("assets/images/products/pro-6.jpg")?>" alt="" />
                                    <div
                                        class="hover-content text-center w-100 position-absolute bottom-0 start-50 translate-middle-x py-2 mb-3">
                                        <a href="cart.html"><i
                                                class="mdi mdi-cart-outline fs-22 me-3 pe-3 fw-bolder pro-icon text-dark border-end"></i></a>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="product-item mt-4">
                                <div class="product-img rounded position-relative">
                                    <img class="img-fluid" src="<?= base_url("assets/images/products/pro-7.jpg")?>" alt="" />
                                    <div
                                        class="hover-content text-center w-100 position-absolute bottom-0 start-50 translate-middle-x py-2 mb-3">
                                        <a href="cart.html"><i
                                                class="mdi mdi-cart-outline fs-22 me-3 pe-3 fw-bolder pro-icon text-dark border-end"></i></a>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="product-item mt-4">
                                <div class="product-img rounded position-relative">
                                    <img class="img-fluid" src="<?= base_url("assets/images/products/pro-8.jpg")?>" alt="" />
                                    <span
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="product-item mt-4">
                                <div class="product-img rounded position-relative">
                                    <img class="img-fluid" src="<?= base_url("assets/images/products/pro-9.jpg")?>" alt="" />
                                    <span
